...
const Skill = (props) => {
    return (
        ...
        <a href={props.targateLink} target="_blank" rel="no-follow" className=' btn border border-white skillbadge' data-bs-toggle="tooltip" data-bs-placement="bottom" title={props.tooltipMsg}>
